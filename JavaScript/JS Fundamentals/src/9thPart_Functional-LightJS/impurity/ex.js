...
function getStudentsByName(students) { 
	...
	students = students.slice();	//pointing at a local copy
...
function getStudentsByID( students ) { 
	//BECAUSE WE ARE NOT LEXICALLY SCOPE LIKE THE GETSTUDENTSBYNAME function, we have to do the brute force 6 steps.
	var origStudents = students.slice();
	students = curStudents.slice();
	var newwStudents = sortStudentsByID() 
